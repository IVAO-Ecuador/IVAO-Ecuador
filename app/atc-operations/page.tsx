				...
				<div className='container py-24 px-8'>
					...
					<div className='w-full bg-hover-color rounded-xl xl:flex mt-8 p-8'>
						...
						<div className='md:flex xl:justify-end justify-center gap-x-5 items-center xl:w-5/12'>
							{/*@ts-ignore*/}
							<a href='/docs/S-OPS-IVAO-Ecuador-QuickViewforATC.xlsx' target='_blank' className='bg-gray-200 text-text-white px-20 py-2 rounded-md max-md:w-full max-md:mb-2 hover:bg-gray transition-all'>{translations[selectedLanguage]?.ATCOp_document_button}</a>
						</div>
					</div>
					...
					<div className='w-full bg-hover-color rounded-xl xl:flex mt-8 p-8'>
						...
						<div className='md:flex xl:justify-end justify-center gap-x-5 items-center xl:w-5/12'>
							{/*@ts-ignore*/}
							<a href='/docs/P-INS-Manual-de-operaciones-ATC.pdf' target='_blank' className='bg-gray-200 text-text-white px-20 py-2 rounded-md max-md:w-full max-md:mb-2 hover:bg-gray transition-all'>{translations[selectedLanguage]?.ATCOp_document_button}</a>
						</div>
					</div>
